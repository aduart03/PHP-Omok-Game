...
class Game{
	...
	static function restore($pid){
		...
		// this is where we would check if pid is valid and exists
		// with invalid pid, return false and handle in the play/index.php file
		...
		// make a new board but overwrite later
		$instance = new self($previous->strategy);
		// convert board to array of arrays
	...
	function checkWin($lastMove){
		...
		//setting it back to a default row (empty array)
		$row = array();
